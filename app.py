        ...
        <div class="fp-box" style="border: 2px solid #00f2ff; background: rgba(0, 0, 0, 0.9); padding: 40px 30px; margin-bottom: 40px; box-shadow: 0 0 30px rgba(0, 242, 255, 0.15); position: relative; border-radius: 4px;">
            ...
            <div style="margin-bottom: 10px;">
                ...
                <p class="fp-p" style="font-size: 15px; color: #d0d0d0; line-height: 1.6;">
                    ...
                    <span style="color: rgb(224, 0, 0); font-size: 13px; font-style: italic; background-color: rgba(0, 242, 255, 0.05); padding: 3px 5px; display: inline-block;">*Please do not hesitate to reach out if you have questions or would like to see additional photos!*</span>
                </p>
            </div>
        </div>
        ...
        <div class="fp-box" style="border: 2px solid #00f2ff; background: rgba(0, 0, 0, 0.95); padding: 40px 30px; box-shadow: 0 0 40px rgba(0, 242, 255, 0.1); position: relative; border-radius: 4px;">
            ...
            <div class="fp-p" style="text-align: left; font-size: 15px; line-height: 1.8; color: #ffffff;">
                <p style="margin-bottom: 20px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 15px;">
                    <strong style="color: #00f2ff; text-transform: uppercase; font-size: 16px;">📦 Shipping &amp; Combined Orders:</strong><br>
                ...
                <p style="margin-bottom: 20px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 15px;">
                    <strong style="color: #00f2ff; text-transform: uppercase; font-size: 16px;">⚡ No Rewinds (Returns):</strong><br>
                ...
                <p style="margin-bottom: 20px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 15px;">
                    <strong style="color: #00f2ff; text-transform: uppercase; font-size: 16px;">⚡ The Real Deal:</strong><br>
                ...
                <p style="margin-bottom: 25px;">
                    <strong style="color: #00f2ff; text-transform: uppercase; font-size: 16px;">⚡ Your Data, Your Timeline:</strong><br>
